...
part of 'multi_img_news_item.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

MultiImgNewsItem _$MultiImgNewsItemFromJson(Map<String, dynamic> json) {
  return MultiImgNewsItem(
      ...
      json['gallary_image_count'] as int,
      json['group_id'] as int,
      json['has_image'] as bool,
      json['has_m3u8_video'] as bool,
      json['has_mp4_video'] as int,
      json['has_video'] as bool,
      json['hot'] as int,
      json['ignore_web_transform'] as int,
      (json['image_list'] as List)
          ?.map((e) =>
              e == null ? null : Image_list.fromJson(e as Map<String, dynamic>))
          ?.toList(),
...
Map<String, dynamic> _$MultiImgNewsItemToJson(MultiImgNewsItem instance) =>
    <String, dynamic>{
      ...
      'gallary_image_count': instance.gallaryImageCount,
...
Image_list _$Image_listFromJson(Map<String, dynamic> json) {
  return Image_list(
      json['height'] as int,
      json['uri'] as String,
      json['url'] as String,
...
Map<String, dynamic> _$Image_listToJson(Image_list instance) =>
    <String, dynamic>{
