...
part 'none_img_news_item.g.dart';

@JsonSerializable()
class NoneImgNewsItem extends Object {
  ...
  factory NoneImgNewsItem.fromJson(Map<String, dynamic> srcJson) =>
      _$NoneImgNewsItemFromJson(srcJson);

  Map<String, dynamic> toJson() => _$NoneImgNewsItemToJson(this);
}
