...
part 'original_list.g.dart';

@JsonSerializable()
class OriginalList extends Object {
  ...
  OriginalList(
    ...
    this.feedFlag,
    this.tips,
    this.hideTopcellCount,
  );

  factory OriginalList.fromJson(Map<String, dynamic> srcJson) =>
      _$OriginalListFromJson(srcJson);

  Map<String, dynamic> toJson() => _$OriginalListToJson(this);
}
...
class Tips extends Object {
  ...
  factory Tips.fromJson(Map<String, dynamic> srcJson) =>
      _$TipsFromJson(srcJson);
