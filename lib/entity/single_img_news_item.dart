...
part 'single_img_news_item.g.dart';

@JsonSerializable()
class SingleImgNewsItem extends Object {
  ...
  factory SingleImgNewsItem.fromJson(Map<String, dynamic> srcJson) =>
      _$SingleImgNewsItemFromJson(srcJson);

  Map<String, dynamic> toJson() => _$SingleImgNewsItemToJson(this);
}
