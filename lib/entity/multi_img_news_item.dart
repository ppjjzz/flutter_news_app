...
part 'multi_img_news_item.g.dart';

@JsonSerializable()
class MultiImgNewsItem extends Object {
  ...
  @JsonKey(name: 'gallary_image_count')
  ...
  factory MultiImgNewsItem.fromJson(Map<String, dynamic> srcJson) =>
      _$MultiImgNewsItemFromJson(srcJson);

  Map<String, dynamic> toJson() => _$MultiImgNewsItemToJson(this);
}
...
@JsonSerializable()
class Image_list extends Object {
  @JsonKey(name: 'height')
  int height;
  ...
  factory Image_list.fromJson(Map<String, dynamic> srcJson) =>
      _$Image_listFromJson(srcJson);

  Map<String, dynamic> toJson() => _$Image_listToJson(this);
}
